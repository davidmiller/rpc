# -*- coding: utf-8 -*-
#
# RPC documentation build configuration file, created by
...
latex_documents = [
  ('index', 'RPC.tex', u'RPC Documentation',
...
texinfo_documents = [
  ('index', 'RPC', u'RPC Documentation',
   u'David Miller', 'RPC', 'One line description of project.',
   'Miscellaneous'),
]
